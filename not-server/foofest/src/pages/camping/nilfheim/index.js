    ...
    <main className={styles.main}>
      ...
      <section className={styles.details} >
        ...
        <div className={styles.allText}>
            ...
            <p className={styles.description}>Enter Nilfheim, where serenity meets excitement. 
            This serene camping area is nestled by a sparkling river, offering a refreshing 
            retreat from the festival's energetic pulse. </p>
